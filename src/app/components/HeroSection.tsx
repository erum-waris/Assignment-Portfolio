...
function HeroSection() {
  return (
    <div  className='flex flex-col pt-5 md:pt-20 md:mt-0 mb-10 m-auto md:mb-5 md:flex-row pl-10 mr-8'>
        <div className='md:m-10 lg:w-full lg:h-full '>

        <Image src="/images/Erum_Logo.jpeg" alt="image" width="350" height="350"
        className='col-span-5 place-self-center lg:w-[450px] lg:h-[450px] rounded-full  hover:animate-spin'/>
  </div>
